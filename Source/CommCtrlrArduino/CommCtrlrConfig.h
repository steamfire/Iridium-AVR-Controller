...
const unsigned long satResponseTimeout = 30000UL;       // (ms) Timeout used when waiting for response timeouts
const unsigned int satSBDIXResponseLost = 60000UL;     // (ms) How much time to wait before assuming SBDIX command failed
